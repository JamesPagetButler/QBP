...
def seed_knowledge_base(db_path: str = "knowledge/qbp.hgdb"):
    ...
    kb.add_concept(
        ...
        "Quaternion Observable Representation",
    ...
    kb.add_theory_axioms(
        [
            ...
            "concept:quaternion-observable",
            "concept:quaternion-evolution",
            "concept:measurement-postulate",
        ],
        theory="QBP",
    ...
    kb.add_research_cluster(
        [
            "question:qbp-divergence",
            "concept:quaternion-pauli-isomorphism",
            "claim:qbp-matches-qm-single",
        ],
    ...
    kb.add_hyperedge(
        (
            "concept:half-angle-formula",
            "concept:su2-double-cover",
            "concept:quaternion-state",
        ),
        "emergence",
        {
