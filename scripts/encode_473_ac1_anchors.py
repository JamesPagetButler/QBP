...
VERIFIER = (
    ...
    "(qbp-oppenheimer, #473 AC1 δ-landscape descent anchors, PR #631); pending cth §I4"
)
...
ANCHORS = {
    ...
    "PROOF-rot120-invariant-form-scalar": (
        ...
        "equation is redundant given the ₁₁ one (trace preservation), and a constructed witness "
        "(p,q,r) = (1,1,0) shows a 180° rotation admits a non-scalar invariant form — order 2 "
        "would NOT suffice. SCOPE: this is the quadratic-form class only; a general "
