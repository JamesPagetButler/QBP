...
ANCHORS = {
    ...
    "PROOF-order-three-automorphism-fixes-ell": (
        CH,
        "The order-3 element ρ of Aut(𝕊)'s S₃ factor, as a CDAut 4: ρ³ = id, ρ(ℓ) = ℓ, ρ ≠ id, multiplicative — and hosting is equivariant under it",
        ...
        "c = −1/2, s² = 3/4 — exactly 3·(2π/3) ≡ 0, nothing goes through at a generic angle): ρ(xy) = ρx·ρy. "
        ...
        "low half to a different half (numerically asserted in p2_cell_torsor_check.py; the halves form a ℤ/3-torsor), so "
