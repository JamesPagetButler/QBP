...
AXIOM1_KILL = (
    ...
    "non-injective on a set of states of positive normalised surface measure on StateSphere, OR "
    "an anchor with proof_state verified "
    ...
    "(omega-limit map injective almost everywhere with respect to that measure). First-order "
    "semiflows are injective at "
