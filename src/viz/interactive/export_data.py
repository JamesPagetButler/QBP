...
DS_NODES = {
    ...
    "coupling_decomposition": {
        ...
        "L1_intuitive": "This is the master equation. Multiply out the brackets using j^2=-1 and j*z=z**j, and you get two intertwined equations. The standard part mixes with the hidden part, and vice versa. They can no longer be separated — they're coupled.",
    ...
    "scenarioC_matches_scenarioA_at_detector": {
        ...
        "L2_physical": "Scenario C: after measurement projects back to the complex subspace (psi_1 = 0), the quaternionic fraction is zero and the system matches Scenario A. Interference is recovered.",
