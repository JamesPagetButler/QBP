...
def show_palette():
    ...
    all_colors = [
        ("METALS", [COLORS.BRASS, COLORS.COPPER, COLORS.BRONZE, COLORS.STEEL, COLORS.GOLD]),
        ("ELEMENTS", [COLORS.TEAL, COLORS.VERDIGRIS, COLORS.AMBER, COLORS.CRIMSON, COLORS.IVORY]),
