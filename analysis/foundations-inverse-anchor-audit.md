...
See `analysis/foundations-inverse-anchor-audit.json` for the machine-readable per-theorem list (576 orphans). Classification (back-fill vs unanchored-by-design) is Phase B (#464).
