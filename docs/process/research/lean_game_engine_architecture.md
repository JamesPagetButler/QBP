...
This document investigates the feasibility of using a real-time game engine as an interactive 3D visualization front-end, driven by a formal proof assistant (Lean 4). It builds upon the previous research (`docs/process/research/lean_golang_architecture.md`) and proposes a more powerful and practical architecture.
